...
const SignUpPage = () => {
  ...
  //fuctn to handle form submission
  const validateForm = () => {
    //precheck using react-toaster that form filled with valid data/format or not;
    ...
    //if everything written correctly then return true;
    return true;
  };
